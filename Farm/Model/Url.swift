...
class URL {
    ...
    let  ADD_FARM_URL = "http://axxentfarms.com/farm/files/pages/app/addf.php"
    let  ADD_FARM_ACTIVITY_URL = "http://axxentfarms.com/farm/files/pages/app/addact.php"
    let ADD_ITEM_TYPE_URL = "http://axxentfarms.com/farm/files/pages/app/additem.php"
    let UPLOAD_DOCUMENT_URL = "http://axxentfarms.com/farm/files/pages/app/uploaddocument.php"
